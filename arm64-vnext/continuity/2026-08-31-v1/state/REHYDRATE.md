...
git -C .\runtime-recovery worktree add --detach ..\generation-evidence `
  fb627b685141eea8bd7e7813837e4b21c754dc35
```
...
| Atomic runtime generation (`e6a17275`) | `crutkas/msys2-runtime`, `crutkas-atomic-runtime-generation`, [PR 34](https://github.com/crutkas/msys2-runtime/pull/34) | **Published** `fb627b685141eea8bd7e7813837e4b21c754dc35`: [`winsup/testsuite/build/evidence/runtime-generation-20260911/README.md`](https://github.com/crutkas/msys2-runtime/blob/fb627b685141eea8bd7e7813837e4b21c754dc35/winsup/testsuite/build/evidence/runtime-generation-20260911/README.md). All 170 original files in `proof.tar.gz`, SHA-256 `2abaa10780ef6e287a2bd90f424d599771aa7db1d72faf354ed81af7557f1c84` (269,076 bytes), plus readable manifests/results. Qualified source remains `df7d66f9b1433c50dd7cd234b0d8bd1213418b22`. |
...
| Provider ledger/admission (`a2dd0a44`, pipeline `2160ef10`) | Build repo, `crutkas-native-provider-intake` / `crutkas-arm64-build-pipeline` | Owner publication requested. Limited libintl/PCRE2 and earlier Ruby admission copies exist here, but the complete latest strict audit, replacement OpenSSL archives and header/provider inventories must be recovered from the owning branch. Names of local archives are not preserved custody. |
...
| [crutkas/msys2-runtime#34](https://github.com/crutkas/msys2-runtime/pull/34) | `df7d66f9b1433c50dd7cd234b0d8bd1213418b22`; evidence-only successor `fb627b685141eea8bd7e7813837e4b21c754dc35` | `crutkas-arm64-runtime-integration` (PR 33) |
